...
cols = ['10 m Model Relative U Component',
       ...
       '950 mb Turbulence Kinetic Energy', 'Surface CIN', 'Surface CAPE',
       'Surface PBL Height', 'Surface Friction Velocity',
       '500 mb Actual Relative Humidity', '1000 mb Actual Relative Humidity',
       '500 mb Vert. Comp. Abs Vorticity', '500 mb Geopotential Height',
       '1000 mb Geopotential Height', '850 mb Geopotential Height',
       '500 mb Temperature', '1000 mb Temperature', 'cos(Zenith)', '80 m Model Speed Cubed',
